    ...
    <nav class="header__nav">
      ...
      <div class="header__rightside">
        <div class="header__select">
          ...
          <div class="header__bar"></div>
          <span id="streamBtn" onclick="show('STREAM'); hide('NEWS'); paint('streamBtn'); painta('newsBtn'); show('ALL'); hide('UFC'); hide('ESPORT'); hide('FIFA'); paint('allBtn'); painta('ufcBtn'); painta('esportBtn'); painta('fifaBtn')" class="stream-btn">Live</span>
        </div>
